export const cms = {
  ...
  '2.2': `I would have thought you’d figure it out already. But my answer to question 28 is no. There, I filled it out for you.`,
  '2.1': `Context clues, ever heard of them? Please stop wasting my time, my answer to question 27 is no.`,
  '2.0': `So, I’m sorry if I hadn’t made it more clear, but my answer to both questions is "No" and "No", can we move this along?`,
